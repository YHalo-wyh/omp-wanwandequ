...
const targets: BinaryTarget[] = [
	{ id: "darwin-arm64", platform: "darwin", arch: "arm64", target: "bun-darwin-arm64", outfile: "packages/coding-agent/binaries/omp-wanwandequ-darwin-arm64" },
	{ id: "darwin-x64", platform: "darwin", arch: "x64", target: "bun-darwin-x64", outfile: "packages/coding-agent/binaries/omp-wanwandequ-darwin-x64" },
	{ id: "linux-x64", platform: "linux", arch: "x64", target: "bun-linux-x64-baseline", outfile: "packages/coding-agent/binaries/omp-wanwandequ-linux-x64" },
	{ id: "linux-arm64", platform: "linux", arch: "arm64", target: "bun-linux-arm64", outfile: "packages/coding-agent/binaries/omp-wanwandequ-linux-arm64" },
	{ id: "win32-x64", platform: "win32", arch: "x64", target: "bun-windows-x64-baseline", outfile: "packages/coding-agent/binaries/omp-wanwandequ-windows-x64.exe" },
	{ id: "win32-arm64", platform: "win32", arch: "arm64", target: "bun-windows-arm64", outfile: "packages/coding-agent/binaries/omp-wanwandequ-windows-arm64.exe" },
];
...
async function build(target: BinaryTarget): Promise<void> {
	...
	if (isDryRun) {
		console.log(`DRY RUN target=${target.target} entry=${path.relative(repoRoot, entrypoint)} outfile=${target.outfile} external=${COMPILED_EXTERNAL_DEPENDENCIES.join(",")}`);
		return;
	}
